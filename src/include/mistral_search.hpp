 ...
 */
  ...
  */
  ...
  /*! \class MaxDomainOverWeight
    \brief  Class MaxDomainOverWeight
  ...
  */
  ...
  public:
    ...
    /**@name Constructors*/
    //@{
	  MaxDomainOverWeight() {dom_ = LARGE_VALUE; wei_ = 0;}
    void initialise(Solver* s, double* _w) {dom_ = LARGE_VALUE; wei_ = 0; weight = _w;}
    //MaxDomainOverWeight(void *w) : weight((double*)w) {dom_ = LARGE_VALUE; wei_ = 0;}
    //@}
    ...
    //@{
    inline double value() { return (wei_ ? (double)dom_/wei_ : (double)INFTY); }
    inline bool operator<( const MaxDomainOverWeight& x ) const { return dom_*x.wei_ > x.dom_*wei_; }
    inline bool operator>( const MaxDomainOverWeight& x ) const { return dom_*x.wei_ < x.dom_*wei_; }
    inline bool operator==( const MaxDomainOverWeight& x ) const { return dom_*x.wei_ == x.dom_*wei_; }
    ...
    inline MaxDomainOverWeight& operator*=( const int x ) { dom_ *= x; return *this; }
    inline MaxDomainOverWeight& operator+=( const int x ) { dom_ += x * wei_; return *this; }
    inline MaxDomainOverWeight& operator-=( const int x ) { dom_ -= x * wei_; return *this; }
    inline MaxDomainOverWeight& operator/=( const int x ) { wei_ *= x; return *this; }


    inline MaxDomainOverWeight& operator*=( const MaxDomainOverWeight& x ) { dom_ *= x.dom_; wei_ *= x.wei_; return *this; }
    inline MaxDomainOverWeight& operator+=( const MaxDomainOverWeight& x ) {
      dom_ = (dom_ * x.wei_ + x.dom_ * wei_);
      wei_ *= x.wei_;
      reduce();
      return *this; }
    ...
    inline void operator=( const MaxDomainOverWeight& x ) { dom_ = x.dom_; wei_ = x.wei_; }
    inline void operator=( const Variable x ) {
      dom_ = x.get_size(); wei_ = weight[x.id()];
      //std::cout << x << ": " << dom_ << "/" << wei_ << ": " << value() << std::endl;
    }
    ...
    std::ostream& display_criterion(std::ostream& os) const {
      os << "with maximum (domain size / weight)";
      return os;
    }
  ...
  std::ostream& operator<<(std::ostream& os, MaxDomainOverWeight& x);
